...
def create_train_test_split(src_dir, dest_dir, train_count=100, test_count=30):
...
def main():
    ...
    create_train_test_split(extracted_dir, output_dir, train_count=100, test_count=30)
